...
export default {
  ...
  methods: {
      ...
      for (let i = 0; i < resize.length; i++) {
        ...
        resize[i].onmousedown = function(e) {
          ...
          document.onmousemove = function(e) {
            ...
            var maxT = box[i].clientWidth - resize[i].offsetWidth - right[i].clientWidth// 容器宽度 - 左边区域的宽度 = 右边区域的宽度
            ...
            for (let j = 0; j < left.length; j++) {
              ...
              mid[j].style.width = box[i].clientWidth - right[i].clientWidth - moveLen - 20 + 'px'
            }
          }
          // 鼠标松开事件
    ...
    // 右边拖动事件
    dragControllerR2L: function() {
      var resize = document.getElementsByClassName('resize1')
      var left = document.getElementsByClassName('mid')
      var mid = document.getElementsByClassName('right')
      var box = document.getElementsByClassName('box')
      var right = document.getElementsByClassName('left')
      console.log(document.getElementsByClassName('resize1'))
      for (let i = 0; i < resize.length; i++) {
        // 鼠标按下事件
        resize[i].onmousedown = function(e) {
          // 颜色改变提醒
