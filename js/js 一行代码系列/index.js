...
// 高级前端进阶
// 大家经常都会保存一些自己常用的代码片段，比如数字每3位添加逗号、日期格式化、解析location.query或location.hash为JSON对象等等。今天带来一篇外网非常火的文章，收集了JavaScript中48个常用的代码片段，同学们可以学习下，部分片段在面试中也经常遇到。
// 下面是正文部分。
...
// 原文链接：http://codebay.cn/post/7452.html
